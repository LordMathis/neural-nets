...
int main()
{
    char *train_inputs_fn = "/home/matus/Projects/personal/matlib/resources/mnist_train_vectors.csv";
    Matrix **train_inputs = load_csv(train_inputs_fn, 60000, 28*28);

    char *train_labels_fn = "/home/matus/Projects/personal/matlib/resources/mnist_train_labels.csv";
    Matrix **train_labels = load_csv(train_labels_fn, 60000, 1);
    vectorize(train_labels, 60000, 10);
 
    char *test_inputs_fn = "/home/matus/Projects/personal/matlib/resources/mnist_test_vectors.csv";
    Matrix **test_inputs = load_csv(test_inputs_fn, 10000, 28*28);

    char *test_labels_fn = "/home/matus/Projects/personal/matlib/resources/mnist_test_labels.csv";
    ...
    train(mnist_network, dataset, monitor, 100, 10, 1);
}